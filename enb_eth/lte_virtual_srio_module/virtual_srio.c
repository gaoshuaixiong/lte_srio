...
int fsm_dev_open(struct net_device *dev)
{
	...
	fsm_core_intf_set(STRM_TO_RLCMAC, DEV_INTF_IND, DEV_PROTO_RLC_MAC, "LTE_RLC_MAC0"); 	//add in 20150804
	fsm_core_intf_set(STRM_TO_ETH, DEV_INTF_REQ, DEV_PROTO_SRIO, "eth2");
    dev_add_pack(&pk_t); 
