/******************************************************************************
 ** Filename:dys_dist_rlc_mac_main.c - 
 ** Copyright: uestc.
 ** Descriptions: dist RLC_MAC
...
MODULE_DESCRIPTION("lterlc_mac kernel module");
MODULE_AUTHOR("");
MODULE_LICENSE("GPL");
...
#define SV_TYPE_NAME		rlc_mac_sv
#define MY_PROTOCOL		DEV_PROTO_RLC_MAC
#define MTU			1500
#define RLC_MAC_ADDR		{0x00,0x11,0x1A,0x1A,0x8A,0x42}			// Six bytes
